...
2. when the plan is complete, sync and attach the doc to the ticket using the MCP tools and create a terse comment with a link to it (re-read .claude/commands/linear.md if needed)
...
View the ticket: https://linear.app/[your-team]/issue/ENG-XXXX/[ticket-slug]
```

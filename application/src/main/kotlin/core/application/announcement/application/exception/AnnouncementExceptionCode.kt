...
enum class AnnouncementExceptionCode(
    ...
    NOT_AN_ASSIGNMENT_EXCEPTION(HttpStatus.BAD_REQUEST, "ANNOUNCEMENT-400-02", "과제가 아닌 공지입니다."),
    ...
    ASSIGNMENT_SUBMISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "ASSIGNMENT-SUBMISSION-404-01", "존재하지 않는 과제 제출 정보입니다."),
    ;

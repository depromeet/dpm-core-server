...
class GatheringV2InviteeCommandController(
    ...
    override fun submitGatheringV2Participant(
        ...
        @RequestBody submitGatheringV2ParticipantRequest: SubmitGatheringV2ParticipantRequest,
    ): CustomResponse<Void> {
        gatheringV2InviteeCommandUseCase.submitGatheringV2Participant(
            memberId = memberId,
            gatheringV2Id = gatheringV2Id,
            isParticipant = submitGatheringV2ParticipantRequest.isParticipant,
        )

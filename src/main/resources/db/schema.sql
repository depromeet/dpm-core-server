...
CREATE TABLE `cohorts` (
                           ...
                           UNIQUE KEY `UKr63et36jlisakbvympgrb3c73` (`value`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `member_oauth` (
                                ...
                                UNIQUE KEY `UKcl5n8qxo9j5ivyoxbrc5uhhxq` (`external_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `bills` (
                         ...
                         PRIMARY KEY (`bill_id`),
                         KEY `FKldoynwtbiwxk3bkgdq4282qh` (`bill_account_id`),
                         CONSTRAINT `FKldoynwtbiwxk3bkgdq4282qh` FOREIGN KEY (`bill_account_id`) REFERENCES `bill_accounts` (`bill_account_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `gatherings` (
                              ...
                              KEY `FKeckxn5utdn2p482nm77vbxc30` (`bill_id`),
                              CONSTRAINT `FKeckxn5utdn2p482nm77vbxc30` FOREIGN KEY (`bill_id`) REFERENCES `bills` (`bill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `receipts` (
                            ...
                            KEY `FKjoq1bhrgv87vtti8d0go7afbq` (`gathering_id`),
                            CONSTRAINT `FKjoq1bhrgv87vtti8d0go7afbq` FOREIGN KEY (`gathering_id`) REFERENCES `gatherings` (`gathering_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `gathering_members` (
                                     ...
                                     KEY `FK7vmlolgrbvgbymswh7qqhy5xe` (`gathering_id`),
                                     CONSTRAINT `FK7vmlolgrbvgbymswh7qqhy5xe` FOREIGN KEY (`gathering_id`) REFERENCES `gatherings` (`gathering_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `receipt_photos` (
                                  ...
                                  KEY `FKqe3p13w642a74nca9hsmmr9rt` (`receipt_id`),
                                  CONSTRAINT `FKqe3p13w642a74nca9hsmmr9rt` FOREIGN KEY (`receipt_id`) REFERENCES `receipts` (`receipt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
